...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
	...
	<div class="container">
        ...
        $statement = $conn->prepare('select * from fashion_products where id=:id');
        ...
        ?>
				...
				<form action="edit.php" method="POST">
				  ...
				  <div class="form-group">
				    ...
				    <input type="number" class="form-control" id="productQuantity" name="quantity" value="<?= $row['quantity'] ?>">
				  </div>

				  <div class="form-group">
				    <label for="productPrice">Product Price</label>
				    <input type="text" class="form-control" id="productPrice" name="price" value="<?= $row['price'] ?>">
				  </div>
